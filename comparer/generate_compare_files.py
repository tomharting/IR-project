...
# Generates data files needed for easy comparison
# For lakh datasets generates query_ioi vectors + query_to_target
# For QBT datasets generates query_ioi vectors + query_to_target + target_ioi vectors
...
# Target vectors are created by running method in trackToVector.createKahlTestSet
...
def create_QBTS_files(test_set_name, query_test_location, target_test_location, mapping_location):
    query_file_location = ROOT_DIR + query_test_location
    ...
    for query in queryFiles:
        ...
        queryVectorMap[query] = trackToVector.tickToIOI(time_differences)
